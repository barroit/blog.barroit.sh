...
page-m4-y := $(addprefix $(m4dir)/,$(page-in))
page-y    := $(objtree)/index.js
...
page-m4-prefix := $(m4dir)/page

prefix-y += $(page-m4-prefix)
terser-in += $(page-y)
onchange-in += $(page-glob)

$(page-credit-m4-y): $(m4dir)/%: % $(fonts-asmap-y) $(images-asmap-y) \
...
clean-page:
	rm -f $(page-m4-y) $(page-y)* $(pubdir)/index-*.js
